...
class PublishingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publishing" do
    assert_difference('Publishing.count') do
      post publishings_url, params: { publishing: { date: @publishing.date, name: @publishing.name, price: @publishing.price } }
    end
  ...
  test "should update publishing" do
    patch publishing_url(@publishing), params: { publishing: { date: @publishing.date, name: @publishing.name, price: @publishing.price } }
